...
public class Home{
	...
	public void homeView(int id) throws SQLException {
		...
		welcome.setFont(new Font("Castellar", Font.PLAIN, 20));
		frame.add(welcome);
		//-----------------------------------------------------------
		...
		students.setForeground(Color.decode("#940002"));
		frame.add(students);
		...
		addattendance.setForeground(Color.decode("#940002"));
		...
		editattendance.setForeground(Color.decode("#940002"));
		...
		teacher.setFont(new Font("Castellar", Font.BOLD, 20));
		teacher.setBackground(Color.decode("#DEE4E7"));
		teacher.setForeground(Color.decode("#940002"));
		frame.add(teacher);
		...
		admin.setForeground(Color.decode("#940002"));
		frame.add(admin);
		...
		classes.setForeground(Color.decode("#940002"));
		frame.add(classes);
