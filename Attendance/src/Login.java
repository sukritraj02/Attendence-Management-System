...
public class Login{
	...
	public void loginView() {
		...
		Font text = new Font("Bahnschrift", Font.PLAIN, 20);
		Home hm = new Home();
		...
		attendance.setForeground(Color.decode("#940002"));
		attendance.setBounds(60, 275, 400, 50);
		attendance.setFont(new Font("Lucida Calligraphy", Font.BOLD, 45));
		frame.add(attendance);
		JLabel management = new JLabel("MANAGEMENT SYSTEM");
		management.setForeground(Color.decode("#940002"));
		management.setBounds(135, 310, 400, 50);
		management.setFont(new Font("Lucida Calligraphy", Font.BOLD, 20));
		...
		x.setFont(new Font("Bahnschrift", Font.BOLD, 20));
		frame.add(x);
		...
		min.setFont(new Font("Bahnschrift", Font.BOLD, 20));
		frame.add(min);
		...
		lgn.setFont(new Font("Bahnschrift", Font.BOLD, 75));
		frame.add(lgn);
		//---------------------------------------------------------------
		...
		username.setForeground(Color.decode("#940002"));
		username.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		frame.add(username);
		//---------------------------------------------------------
		...
		password.setForeground(Color.decode("#940002"));
		frame.add(password);
		//---------------------------------------------------------
		...
		login.setForeground(Color.decode("#940002"));
		frame.add(login);
		...
		frame.getContentPane().setBackground(Color.decode("#940002"));
