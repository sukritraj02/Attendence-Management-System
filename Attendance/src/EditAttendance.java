...
public class EditAttendance {
	...
	public void editView() throws SQLException {
		...
		dtbox.setFont(text);
		dtbox.setForeground(Color.decode("#940002"));
		...
		view.setForeground(Color.decode("#940002"));
		frame.add(view);
		...
		ab.setForeground(Color.decode("#940002"));
		frame.add(ab);
		...
		pre.setForeground(Color.decode("#940002"));
		frame.add(pre);
		...
		sbmt.setForeground(Color.decode("#940002"));
		frame.add(sbmt);
		...
		del.setForeground(Color.decode("#940002"));
		frame.add(del);
