...
public class Admin{
	...
	Font text = new Font("Bahnschrift", Font.PLAIN, 18);
	Connection con;
	int check;
	JButton edit;
	JButton delete;
	...
	public void adminView() throws NumberFormatException, SQLException {
		...
		Font btn = new Font("Bahnschrift", Font.BOLD, 20);
		
		//------------------------CLOSE---------------------------
		JLabel x = new JLabel("X");
		x.setForeground(Color.decode("#940002"));
		x.setBounds(965, 10, 100, 20);
		x.setFont(new Font("Castellar", Font.BOLD, 20));
		frame.add(x);
		...
		back.setForeground(Color.decode("#940002"));
		back.setFont(new Font("Castellar", Font.BOLD, 17));
		...
		idbox.setFont(text);
		idbox.setForeground(Color.decode("#940002"));
		...
		name.setFont(text);
		name.setForeground(Color.decode("#940002"));
		...
		save.setForeground(Color.decode("#940002"));
		...
		edit.setForeground(Color.decode("#940002"));
		frame.add(edit);
		...
		add.setForeground(Color.decode("#940002"));
		frame.add(add);
		...
		delete.setForeground(Color.decode("#940002"));
		delete.setEnabled(false);
		frame.add(delete);
