...
public class StudentView {
	...
	public void stView(int id) throws SQLException {
		...
		x.setForeground(Color.decode("#940002"));
		...
		min.setForeground(Color.decode("#940002"));
		...
		welcome.setFont(new Font("Bahnschrift", Font.PLAIN, 20));
		frame.add(welcome);
		//-----------------------------------------------------------
		...
		table.setFont(new Font("Bahnschrift", Font.BOLD, 20));
